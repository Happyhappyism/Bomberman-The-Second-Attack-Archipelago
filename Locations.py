...
class BombTSALocationData(NamedTuple):
    ...
    dark_bomb_exclude:Optional[bool] = False
...
location_data_table: Dict[str, BombTSALocationData] = {
    ...
    "Starlight Ace Of Spades": BombTSALocationData(
...
#powerup_data_table: Dict[str, BombTSALocationData] = {
   # Remote Bombs
    ...
    "Aquanet Glove Tower 1F": BombTSALocationData(
        region="Aquanet, Tower 1F",
        address=0x1C30C5,
  		loc_type= "Powerup",
		base_loc=False,
	),
...
dark_bomb_exc_list = [name for name, data in location_data_table.items() if data.dark_bomb_exclude == True]
