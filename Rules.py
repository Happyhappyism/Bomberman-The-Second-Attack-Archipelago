...
from .Locations import dark_bomb_exc_list
...
def can_open_car(state, player):
    return state.has("Guardian Glove", player) or (state.has("Earth Stone", player) and state.has("FireUp", player, 2))
...
def can_hit_high_object(state,player):
    return state.has("Guardian Glove", player) or (state.has("Ice Stone",player) and state.has("FireUp", player, 2)) or state.has("Light Stone", player)

def can_hit_from_high_ledge(state,player):
    return state.has("Lightning Stone", player) and state.has("Guardian Helmet", player) and state.has("Guardian Boots", player) and state.has("FireUp", player, 2)
...
def get_location_rules(player):
    rule_list = {
        ...
        "Alcatraz Part Yellow":
            lambda state: state.has("Guardian Glove", player),
        "Alcatraz Generator":
            lambda state: can_hit_high_object(state,player) or state.has("Dark Stone", player),
        ...
        "Horizon Remote Second Trial":
            lambda state: can_destroy_with_immunity(state,player,["Dark Stone"]),
        "Horizon Glove Eastern Tower":
            lambda state: can_destroy_with_immunity(state,player,["Dark Stone"]),
        "Horizon Kick Leading Road":
            lambda state: can_destroy_with_immunity(state,player,["Dark Stone"]),
        "Horizon Part Green":
            lambda state: can_destroy_with_immunity(state,player,["Dark Stone"]),
        "Horizon Glove Basement Hub":
            lambda state: can_destroy_with_immunity(state,player,["Dark Stone"]),
        "Horizon Kick Last Route":
            lambda state: can_destroy_with_immunity(state,player,["Dark Stone"]),
        ...
        "Horizon Remote Final Deposit":
            lambda state: state.has("Guardian Glove", player) and can_destroy_with_immunity(state,player,["Dark Stone"]),
         # Wind Bomb
        ...
        "Starlight Remote Waiting Room":
            lambda state: state.has("Wind Stone", player) and (can_hit_high_object(state,player) or can_hit_from_high_ledge(state, player)),
        "Starlight Generator":
        ...
        "Neverland Molok Defeated":
            lambda state: can_destroy_with_immunity(state, player, ["Dark Stone"]),
        "Neverland Kick Intersection":
            lambda state: can_destroy_with_immunity(state, player, ["Dark Stone"]),
        "Neverland Kick Cage Room":
            lambda state: can_destroy_with_immunity(state, player, ["Dark Stone"]),
